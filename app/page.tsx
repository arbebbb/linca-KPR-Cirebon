    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <div className="flex items-center">
                <img src="/logotp.png" alt="LINCA Logo" className="h-16 md:h-20 w-auto" />
              </div>
              <p className="text-gray-600 mt-2">Tracking Progress KPR & Consumer Loan</p>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <Card className="mb-6">
            <CardHeader>
              <CardTitle className="text-navy-500">Cek Status Kredit Anda</CardTitle>
              <CardDescription>Masukkan nama Anda untuk melihat informasi status kredit</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col md:flex-row gap-3">
                <div className="flex-1 relative">
                  ...
                  <Input
                    placeholder="Masukkan nama Anda (contoh: Frans Ronald)"
                    className="pl-10"
                    value={query}
            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p>Masukkan nama Anda untuk mulai mencari</p>
                </div>
              ) : results.length === 0 ? (
                <div className="text-center py-12 text-muted-foreground">
                  <Search className="h-12 w-12 mx-auto mb-4 opacity-50" />
                  <p>Data tidak ditemukan</p>
                  <p className="text-sm mt-2">Pastikan nama yang Anda masukkan sudah benar</p>
                </div>
              ) : (
